...
namespace protobuf_ROOTFilePB_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "ROOTFilePB.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
ROOTFilePB_Histo::ROOTFilePB_Histo()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_ROOTFilePB_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* ROOTFilePB_Histo::descriptor() {
  protobuf_ROOTFilePB_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_ROOTFilePB_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata ROOTFilePB_Histo::GetMetadata() const {
  protobuf_ROOTFilePB_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_ROOTFilePB_2eproto::file_level_metadata[kIndexInFileMessages];
}
  ...
  for (unsigned int i = 0, n = this->histo_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->histo(i), deterministic, target);
  }
