...
namespace l1t {
  namespace emtf {
    ...
    ME() : 
      wire(-99), quality(-99), clct_pattern(-99), bc0(-99), bxe(-99), lr(-99), 
	csc_ID(-99), strip(-99), afff(-99), cik(-99), nit(-99), me_bxn(-99),
	afef(-99), se(-99), sm(-99), epc(-99), af(-99), station(-99), vp(-99), tbin(-99),
	stub_num(-99), format_errors(0), dataword(-99) 
	{};
